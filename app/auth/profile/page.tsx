    ...
    return (
        <div className='flex items-center w-full h-100 justify-center'>
            <div className={'min-w-[375px] max-w-50 p-4'}>
                <p className='text-base font-semibold my-2'>My Profile</p>
                <ProfileUpdateForm />
                <Separator className='my-4' />
                <p className='text-base font-semibold my-2'>Change Password</p>
                <PasswordUpdate />
                <Separator className='my-4' />
                <p className='text-base font-semibold my-2'>Account Management</p>
